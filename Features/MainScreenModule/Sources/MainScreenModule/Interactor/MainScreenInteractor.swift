...
final class MainScreenInteractor: MainScreenInteractorInput {
  ...
  private let encryptionService: EncryptionServiceAbstraction
  private let permissionService: PermissionServiceAbstraction
  ...
  ///   - permissionService: Сервис получения разрешений
  init(_ encryptionService: EncryptionServiceAbstraction,
       _ permissionService: PermissionServiceAbstraction) {
